...
require_once 'vendor/google/recaptcha/src/autoload.php';
 $privatekey = "6Ld9kqEUAAAAAM67TxyjmXWPeaM7mHimQD2A7Rrs";
//  $resp = recaptcha_check_answer ($privatekey,
//                                $_SERVER["REMOTE_ADDR"],
//                                $_POST["recaptcha_challenge_field"],
//                                $_POST["recaptcha_response_field"]);
// $recaptcha = new \ReCaptcha\ReCaptcha($privatekey);
// $resp = $recaptcha->setExpectedHostname('nepsod.fr')
//                   ->verify(
...
//         "(reCAPTCHA said: " . implode(",",$resp->getErrorCodes()) . ")");
...
$_SESSION['message'] = NULL;
 ...
 //$headers[] = 'To: Mary <mary@example.com>, Kelly <kelly@example.com>';
  ...
  $from = 'robin.paitry@laposte.net';
  $headers[]= 'From: ' .$from;
  $to = 'robin.paitry@laposte.net'; // Insérer votre adresse email ICI
